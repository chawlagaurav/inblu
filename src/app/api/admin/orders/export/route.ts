    ...
    const rows = orders.map((order) => {
      ...
      return {
        ...
        'Shipping Address': address
          ...
          : '',
        'Address - First Name': address?.firstName || '',
        'Address - Last Name': address?.lastName || '',
        ...
        'Stripe Payment Intent': order.stripePaymentIntent || '',
        ...
        'Last Updated': new Date(order.updatedAt).toLocaleDateString('en-AU', {
          year: 'numeric',
          month: 'short',
          day: 'numeric',
          hour: '2-digit',
