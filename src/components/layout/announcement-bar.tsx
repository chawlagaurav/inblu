    ...
    <div className="relative bg-blue-600 text-white text-sm">
      <div className="max-w-7xl mx-auto pl-4 pr-10 py-2 flex items-center justify-center gap-2">
        ...
        {banner.link && (
          <Link
            href={banner.link}
            className="inline-flex items-center gap-1 font-semibold underline underline-offset-2 hover:text-blue-100 transition-colors whitespace-nowrap"
          >
            Shop Now
        ...
        <button
          ...
          className="absolute right-2 top-1/2 -translate-y-1/2 p-1.5 hover:bg-blue-700 rounded transition-colors"
